          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <a href="tel:8693022000" style={{ color: '#e76c2c' }}>8693022000</a>
                  <br />
                  <a href="tel:8419904009" style={{ color: '#e76c2c' }}>8419904009</a>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <a href="mailto:rsg1507@gmail.com" style={{ color: '#e76c2c' }}>
                    rsg1507@gmail.com
                  </a>
                </p>
              </div>
